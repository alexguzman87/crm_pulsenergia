                            ...
                            <div class="row">
                                <div class="col-md-11">
                                    <div class="d-flex flex-wrap align-items-start justify-content-md-star mt-2 mt-md-0 gap-2 mb-3"> 
                                        <form action="/config_lead_origin_update/{{$origin->id}}" method="POST">
                                            @csrf
                                            @method('PUT')
                                                <input type="text" name="name" value="{{$origin->name}}" aria-label="Type a keyword..." class="gridjs-input gridjs-search-input" required>
                                                <button type="submit" name="send" title="MODIFICAR ORIGEN" class="btn btn-primary"><i class="bx bx-save"></i></button>
                                        </form>
