            ...
            <div class="task-board">
                <div class="task-list">
                    <div class="card shadow-none h-100">
                        <div class="card-header bg-transparent border-bottom d-flex align-items-start">
                            <div class="flex-grow-1">
                                <h4 class="card-title mb-0">OPORTUNIDAD <span class="font-size-14 text-muted">(03)</span></h4>
                            </div>
                ...
                <div class="task-list">
                    <div class="card shadow-none h-100">
                        <div class="card-header bg-transparent border-bottom d-flex align-items-start">
                            <div class="flex-grow-1">
                                <h4 class="card-title mb-0">EN PROPUESTA <span class="font-size-14 text-muted">(01)</span></h4>
                            </div>
                            <div class="flex-shrink-0 ms-2">
                                <div class="dropdown">
                                    <a href="#" class="dropdown-toggle arrow-none font-size-16" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="task-list">
                    <div class="card shadow-none h-100">
                        <div class="card-header bg-transparent border-bottom d-flex align-items-start">
                            <div class="flex-grow-1">
                                <h4 class="card-title mb-0">NECESITO APOYO <span class="font-size-14 text-muted">(02)</span></h4>
                            </div>
                            <div class="flex-shrink-0 ms-2">
                                <div class="dropdown">
                                    <a href="#" class="dropdown-toggle arrow-none font-size-16" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="task-list">
                    <div class="card shadow-none h-100">
                        <div class="card-header bg-transparent border-bottom d-flex align-items-start">
                            <div class="flex-grow-1">
                                <h4 class="card-title mb-0">VENTA EXITOSA <span class="font-size-14 text-muted">(03)</span></h4>
                            </div>
                            <div class="flex-shrink-0 ms-2">
                                <div class="dropdown">
                                    <a href="#" class="dropdown-toggle arrow-none font-size-16" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="task-list">
                    <div class="card shadow-none h-100">
                        <div class="card-header bg-transparent border-bottom d-flex align-items-start">
                            <div class="flex-grow-1">
                                <h4 class="card-title mb-0">PÉRDIDO<span class="font-size-14 text-muted">(03)</span></h4>
                            </div>
                            <div class="flex-shrink-0 ms-2">
                                <div class="dropdown">
                                    <a href="#" class="dropdown-toggle arrow-none font-size-16" data-bs-toggle="dropdown" aria-expanded="false">
